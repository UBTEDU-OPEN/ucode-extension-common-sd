...
import { ITcp, TCPEvents, ListenOptions, ServerOpts, SocketConnectOpts, SocketConstructorOpts, BufferEncoding } from './interface';
export declare class TCPAdapter extends EventEmitter implements ITcp {
    /**
     * events.EventEmitter
