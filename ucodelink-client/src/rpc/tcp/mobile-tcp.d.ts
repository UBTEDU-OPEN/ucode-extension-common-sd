...
import { TCPEvents, ITcp, ListenOptions, ServerOpts, SocketConnectOpts, SocketConstructorOpts } from './interface';
export declare class MobileTCP extends EventEmitter implements ITcp {
    /**
     * events.EventEmitter
